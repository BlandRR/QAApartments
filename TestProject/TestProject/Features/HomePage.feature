...
Scenario: Navigate to the Apartment page
	Given I have gone to the url "http://35.178.15.189:49160/"
	When I click the Apartment button on the banner
	Then I should have been redirected to the page with url "http://35.178.15.189:49160/apartment"

Scenario: Navigate to the Calendar Page
	Given I have gone to the url "http://35.178.15.189:49160/"
	When I click the calendar button on the banner
	Then I should have been redirected to the page with url "http://35.178.15.189:49160/calendar"

Scenario: Navigate to the add person page
	Given I have gone to the url "http://35.178.15.189:49160/"
	When I click the Add Person button
	Then I should have been redirected to the page with url "http://35.178.15.189:49160/AddPerson"

Scenario: Navigate to the add apartment page
	Given I have gone to the url "http://35.178.15.189:49160/"
	When I click the add apartment button
	Then I should have been redirected to the page with url "http://35.178.15.189:49160/apartments/addApartment"
